...
public class AdInventories {
    ...
    public static AdInventories newInstance(String id, String name) {
        AdInventories adInventories = new AdInventories();
        adInventories.ts = System.currentTimeMillis();
        adInventories.inventoryID = id;
        adInventories.newsType = name;

        return adInventories;
    }
